...
int main(int argc, char *argv[])
{
	...
	char number[4]={4,4,4};
	char number2[4]={4,4,4};
	char number4[4]={4,4,4};
	char number8[4]={4,4,4};
	...
	if (ret == -1)
{
	...
	sprintf (number2, "%d", ((int)default_rx[0])/2);
	sprintf (number4, "%d", ((int)default_rx[0])/4);
	sprintf (number8, "%d", ((int)default_rx[0])/8);
	fsr_file << number << "\t" << number2 << "\t" << number4 <<"\t" << number8 <<"\n";
	usleep(100000);
	}
